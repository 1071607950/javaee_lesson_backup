...
public class BookRoomServlet extends HttpServlet {
    BookRoomService bookRoomService = DaoFactory.getBookRoomServiceInstance();
    BookRoommodel bookRoom = DaoFactory.getBookRoomInstance();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (flagText != null && flagText.equals("allBookRoom")) {
            ...
            bookRoom = new BookRoommodel(Integer.parseInt(bookroom_id), bookroom_name, bookroom_phone, bookroom_address);
            ...
            bookRoom = new BookRoommodel(-1, bookroom_name, bookroom_phone, bookroom_address);
