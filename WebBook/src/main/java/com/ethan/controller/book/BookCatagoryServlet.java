...
public class BookCatagoryServlet extends HttpServlet {
    BookCatagorymodel bookCatagory = DaoFactory.getBookCatagoryInstance();
    BookCatagoryService bookCatagoryService = DaoFactory.getBookCatagoryServiceInstance();
...
//            System.out.println(book_catagory_room.toString());
            ...
            bookCatagory = new BookCatagorymodel(Integer.parseInt(bookcatagory_id), bookcatagory_name, Integer.parseInt(bookcatagory_brid), bookcatagory_demo);
            ...
            bookCatagory = new BookCatagorymodel(-1, bookcatagory_name, Integer.parseInt(bookcatagory_brid), bookcatagory_demo);
            ...
            List<AllEntitymodel> bookCatagories = null;
            int total = 0;
            ...
            AllEntitymodel book_catagory_room = new AllEntitymodel();
