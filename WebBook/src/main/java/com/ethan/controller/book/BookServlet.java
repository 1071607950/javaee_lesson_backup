...
public class BookServlet extends HttpServlet {
    Bookmodel book = DaoFactory.getBook();
    BookService bookService = DaoFactory.getBookServiceInstance();
...
//            System.out.println(book_catagory_room.toString());
            ...
            int code = 0;
            try {
                Bookmodel book = new Bookmodel(book_ISBN, Integer.parseInt(book_catagoryId), book_name, book_publish, book_author, DateUtil.formatString(book_publishDate, "yyyy-MM-dd"), Float.valueOf(book_price), DateUtil.formatString(book_storageDate, "yyyy-MM-dd"), Integer.parseInt(book_stockNumber), Integer.parseInt(book_inNumber));
