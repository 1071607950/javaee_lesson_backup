...
public class BorrowServlet extends HttpServlet {
    BorrowService borrowService = DaoFactory.getBorrowServiceInstance();
    Borrowmodel borrow = DaoFactory.getBorrowInstance();
...
//            Date borrow_dueDate  =new Date();
            ...
            try {
                ...
                if (days > 0) {
                    ...
                    Ticketmodel ticket = new Ticketmodel(0, allEntity.getBorrow_bcid(), allEntity.getBorrow_ISBN(), fine, DateUtil.formatString(borrow_dueDate, "yyyy-MM-dd"));
                    TicketService ticketService = DaoFactory.getTicketServiceInstance();
