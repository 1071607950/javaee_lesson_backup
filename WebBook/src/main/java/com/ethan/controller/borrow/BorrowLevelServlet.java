...
public class BorrowLevelServlet extends HttpServlet {
    BorrowLevelService borrowLevelService = DaoFactory.getBorrowLevelServiceInstance();
    BorrowLevelmodel borrowLevel = DaoFactory.getBorrowLevelInstance();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (flagText != null && flagText.equals("allBorrowLevel")) {
            ...
            List<BorrowLevelmodel> borrowLevels = null;
            int total = 0;
