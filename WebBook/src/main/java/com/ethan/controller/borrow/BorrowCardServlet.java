...
public class BorrowCardServlet extends HttpServlet {
    BorrowCardmodel borrowCard = DaoFactory.getBorrowCardInstance();
    BorrowCardService borrowCardService = DaoFactory.getBorrowCardServiceInstance();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (flagText != null && flagText.equals("allBorrowCard")) {
            ...
            List<AllEntitymodel> borrowCards = null;
            int total = 0;
