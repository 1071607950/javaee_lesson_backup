 ...
 */
public class BookCatagorymodel {
    private int bookcatagory_id;
    private String bookcatagory_name;
    private int bookcatagory_brid;
    private String bookcatagory_demo;

    public BookCatagorymodel() {
    }

    public BookCatagorymodel(int bookcatagory_id, String bookcatagory_name, int bookcatagory_brid, String bookcatagory_demo) {
