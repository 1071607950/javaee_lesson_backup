...
public class BorrowLevelmodel {
    ...
    public BorrowLevelmodel() {
    }

    public BorrowLevelmodel(int borrowlevel_id, String borrowlevel_name, int borrowlevel_quantity, int borrowlevel_days, float borrowlevel_fine, String borrowlevel_demo) {
